...
func (b *Bird) Start() {
	...
	if b.dir {
		b.Transform().SetPosition(cp.Add(engine.Vector{-610, float32(rand.Intn(300)) + 100, 0}))
		sc.X *= -1
	} else {
		b.Transform().SetPosition(cp.Add(engine.Vector{860, float32(rand.Intn(300)) + 100, 0}))
	}
